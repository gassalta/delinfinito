...
get_header(); ?>
    ...
    <div class="main-wrapper">
        ...
        <div class="cover-section w-100 vh-100 position-relative">
            <div class="bg w-100 vh-100 position-relative" data-aos="fade-up" data-aos-once="true" data-aos-anchor-placement="top-bottom" data-aos-delay="500" data-aos-duration="1300" style="background: url('<?php echo $img_dest_muestras_big_out; ?>')">
            </div>
        ...
        <?php if ( have_rows('img_slideshow_muestras_rep') ) : ?>    
            <div id="muestra" data-aos="fade-up" data-aos-once="true" data-aos-anchor-placement="top-bottom" data-aos-delay="500" data-aos-duration="1300">
                ...
                <?php while( have_rows('img_slideshow_muestras_rep') ) : the_row();
                    // vars 
                    ...
                    // $width = $img_slideshow_muestras['sizes'][ $size . '-width' ];
                    // $height = $img_slideshow_muestras['sizes'][ $size . '-height' ];
                    ?>
                    <div class="gallery-cell">
                        <img src="<?php echo $img_slideshow_muestras_out; ?>" alt="" data-src="<?php echo $img_slideshow_muestras_out_large; ?>"/>
                    </div>
                <?php endwhile; ?>
            </div>
        <?php endif; ?>         
                ...
                <div class="carousel" data-flickity='{ "imagesLoaded": true, "groupCells": true, "groupCells": 1, "percentPosition": false, "wrapAround": true, "autoPlay": true, "prevNextButtons": false }'>
                    <?php while ( $query->have_posts() ) : $query->the_post();
                        ...
                        <a class="carousel-cell" href="<?php the_permalink(); ?>">
                            ...
                            <img src="<?php echo $img_dest_muestras_out; ?>" alt="" class="img-fluid">
